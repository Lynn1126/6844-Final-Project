        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User
                {
                    ...
                    Username = "admin",
                    Email = "admin@cardtradehub.com",
                    // Fixed hash value for password: Admin123!
                    // This hash value is pre-generated using ASP.NET Core Identity PasswordHasher
                    PasswordHash = "AQAAAAEAACcQAAAAEE3q0s5tdZR5qih3lzn8q6VhYhZJwcIoNqhTYmhZGdtS3wPVHCtLQXJvHnaSH4TiQw==",
                    Role = "Admin",
                    IsActive = true,
                    CreatedAt = _seedDate,
                    RegisterDate = _seedDate,
